...
def seed_ahmedabad_bins(cursor):
    sample_bins = [
        ...
        ('BIN-103', 'Satellite ISRO Circle Junction', 23.0270, 72.5180, 42, 100.0, 42.0, 'Organic & Wet Waste', 98, 28.0, 130.0, 69.6, 'ONLINE', 'bin103_cam.jpg', '192.168.1.103', 'NORMAL', 'Static', '10:40'),
        ...
        ('BIN-106', 'Maninagar Kankaria Gate 3', 23.0060, 72.6010, 35, 100.0, 35.0, 'Organic Waste', 95, 27.5, 115.0, 78.0, 'ONLINE', 'bin106_cam.jpg', '192.168.1.106', 'NORMAL', 'Static', '11:18'),
        ...
        ('BIN-108', 'Bodakdev Judges Bungalow Road', 23.0420, 72.5130, 60, 100.0, 60.0, 'Hazardous & Medical', 88, 28.5, 160.0, 48.0, 'ONLINE', 'bin108_cam.jpg', '192.168.1.108', 'NORMAL', 'Static', '11:42'),
        ...
        ('BIN-110', 'Naroda Industrial Estate Gate 2', 23.0720, 72.6510, 89, 250.0, 222.5, 'E-Waste & Heavy Metal', 91, 35.5, 280.0, 13.2, 'ONLINE', 'bin110_cam.jpg', '192.168.1.110', 'OVERFLOW_CRITICAL', 'Sensor', '12:10')
    ]
