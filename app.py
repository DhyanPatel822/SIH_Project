...
from .database import (
    ...
    add_citizen_report, fetch_all_reports, save_optimized_route
)
...
def get_bin_hardware(bin_id):
    ...
    hardware_info = {
        ...
        'camera_status': bin_data['camera_status'],
        'ultrasonic_sensor': {
...
def handle_reports():
    if request.method == 'POST':
        ...
        category = data.get('waste_category', 'Overflow Dustbin')
        desc = data.get('description', '')

        report_id = add_citizen_report(name, phone, lat, lng, address, category, desc)
